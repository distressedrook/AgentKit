...
///
/// A schema enumerates the tools, groundings, and structured outputs that AgentKit should resolve
...
public protocol LanguageModelSessionSchema {
  ...
  associatedtype DecodedGrounding: AgentKit.DecodedGrounding

  /// Your app's type that represents a resolved tool run.
  associatedtype DecodedToolRun: AgentKit.DecodedToolRun

  /// Your app's type that represents a resolved structured output.
  associatedtype DecodedStructuredOutput: AgentKit.DecodedStructuredOutput

  associatedtype StructuredOutputs

  typealias Transcript = AgentKit.Transcript.Resolved<Self>
...
public extension LanguageModelSessionSchema {
  ...
  func resolve(_ transcript: AgentKit.Transcript) throws -> Transcript {
...
public struct NoSchema: LanguageModelSessionSchema {
  ...
  public struct DecodedGrounding: AgentKit.DecodedGrounding {}
  public struct DecodedToolRun: AgentKit.DecodedToolRun {
  ...
  public struct DecodedStructuredOutput: AgentKit.DecodedStructuredOutput {
