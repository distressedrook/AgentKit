...
///
/// Because the generic parameter is your concrete tool, AgentKit guarantees type-safety all the way from
...
public struct ToolRun<Tool: FoundationModels.Tool>: Identifiable where Tool.Arguments: Generable,
  ...
  ///
  /// While the provider streams tokens, AgentKit surfaces a `partial` projection backed by
