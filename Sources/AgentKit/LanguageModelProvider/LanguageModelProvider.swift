...
public protocol LanguageModelProvider<SessionSchema>: AnyObject, Sendable {
  typealias Transcript = AgentKit.Transcript
  typealias Response<StructuredOutput: AgentKit.StructuredOutput> = AgentResponse<StructuredOutput>
  typealias Snapshot<StructuredOutput: AgentKit.StructuredOutput> = AgentSnapshot<StructuredOutput>

  associatedtype Adapter: AgentKit.Adapter & SendableMetatype
  associatedtype SessionSchema: LanguageModelSessionSchema = AgentKit.NoSchema
...
package extension LanguageModelProvider {
  ...
  func processResponse<StructuredOutput: AgentKit.StructuredOutput>(
  ...
  func processResponseStream<StructuredOutput: AgentKit.StructuredOutput>(
    from prompt: Transcript.Prompt,
    generating type: StructuredOutput.Type?,
    using model: Adapter.Model,
    options: Adapter.GenerationOptions?,
