...
public actor SimulationAdapter: Adapter {
  ...
  public typealias Transcript = AgentKit.Transcript
  ...
  private let storedTools: [any AgentKitTool]
  private let configuredDefaultGenerations: [SimulatedGeneration]
  private var nextDefaultGenerationIndex: Int

  public nonisolated var tools: [any AgentKitTool] {
    storedTools
  }

  public init(tools: [any AgentKitTool], instructions: String, configuration: SimulationConfiguration) {
