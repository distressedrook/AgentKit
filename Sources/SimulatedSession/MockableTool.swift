...
/// in the AgentKit simulation system.
///
...
///
/// This protocol is used by the AgentKit simulation system when using
...
/// }
/// ```
public protocol MockableStructuredOutput where Self: AgentKit.StructuredOutput {
  /// The associated content type that can be generated.
  ///
  /// This type must conform to `AgentKit.StructuredOutput.Schema` to be compatible with the
  /// AgentKit generation system.
  associatedtype StructuredOutput: AgentKit.StructuredOutput
